...
You can then execute your native executable with: `./target/pizzaria-1.0.0-SNAPSHOT-runner`
...
- Web Bundler - Tailwind CSS ([guide](https://docs.quarkiverse.io/quarkus-web-bundler/dev/integrations.html#tailwindcss)): Add support for bundling with Tailwind CSS 4+
